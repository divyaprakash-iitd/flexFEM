...
On this branch I am working on implementing the code in Fortran.
...
- Duki, S. F., Kolmakov, G. V., Yashin, V. V., Kowalewski, T., Matyjaszewski, K., & Balazs, A. C. (2011). Modeling the nanoscratching of self-healing materials. The Journal of Chemical Physics, 134(8), 084901.
